            ...
            <div className="prose dark:prose-invert max-w-full space-y-4">
                {subMateris.length > 0 ? (
                    subMateris.map((sub, index) => (
                        ...
                        className="max-w-full w-full scroll-mt-24 bg-slate-50 dark:bg-gray-800/50 p-2 rounded-xl border border-slate-200 dark:border-gray-700/60 shadow-sm border-l-4 border-l-blue-500"
                        >
