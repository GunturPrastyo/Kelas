...
export default function Navbar() {
  ...
  return (
    <header
      ...
      className={`bg-white/80 dark:bg-gray-900/80 border-b border-gray-200/80 dark:border-gray-700/80 p-4 flex justify-between items-center backdrop-blur-sm fixed top-0 right-0 z-40 gap-4 h-20 transition-all duration-300 w-full`}
    >
      {/* Kiri */}
