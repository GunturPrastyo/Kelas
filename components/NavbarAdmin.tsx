...
export default function Navbar() {
  ...
  return (
    <header
      ...
      className={`bg-white/80 dark:bg-gray-900/80 border-b border-gray-200/80 dark:border-gray-700/80 p-4 flex justify-between items-center backdrop-blur-sm fixed max-w-full top-0 right-0 z-40 gap-4 h-20 mb-10 transition-all duration-300 ${
    ...
    >
      ...
      <div id="header-left" className="flex items-center flex-shrink-0" suppressHydrationWarning>
        ...
        <div id="header-title-placeholder" suppressHydrationWarning>
          {isSidebarCollapsed && (
            <Image src="/logo.webp" alt="KELAS Logo" width={150} height={40} className="h-10 w-auto" />
          )}
        </div>
      </div>
