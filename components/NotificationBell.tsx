                            ...
                            notifications.map(notif => (
                                <div key={notif._id} className="group relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-2 right-2 p-1 rounded-full text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100 hover:bg-gray-200 dark:hover:bg-gray-600 transition-opacity"
                                    >
                                        <X size={14} />
